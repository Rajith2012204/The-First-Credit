...
-- Dumping data for table first_credit.fc_group: ~0 rows (approximately)
...
INSERT INTO `fc_user` (`user_name`, `password`, `user_type`, `first_time_login`, `last_login_time`, `employee_id`, `approve_mode`, `description`, `modified_by`, `modified_date`, `status`, `added_by`, `added_date`) VALUES
	('admin', '$2a$10$upNlurIcUu7BXA9i24HewuA5eQMq57mCq9jkmGQ8IbYtewRDZRX.a', 'Employee', 0, '2017-02-13 03:03:47', 'E001', 'Approved', NULL, 'admin', '2017-02-12', 'Active', 'admin', '2017-02-12 02:49:56');
